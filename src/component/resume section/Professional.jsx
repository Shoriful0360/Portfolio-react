    ...
    <section className="px-6 md:px-12 lg:px-20 py-12 font-serif">
      <div className="grid md:grid-cols-3 gap-12">
        ...
        <div data-aos="fade-down" data-aos-duration="1500">
          ...
          <h1 className="text-xl font-bold underline mb-6">Design Skills</h1>
        ...
        <div data-aos="fade-up" data-aos-duration="1500">
          ...
          <h1 className="text-xl font-bold underline mb-6">Frontend Development</h1>
        ...
        <div data-aos="fade-down" data-aos-duration="1500">
          ...
          <h1 className="text-xl font-bold underline mb-6">Backend & Tools</h1>
